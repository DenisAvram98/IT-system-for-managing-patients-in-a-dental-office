<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContPacientAutentificare.aspx.cs" Inherits="CabStomatologic.ContPacientAutentificare" %>
                                        ...
                                        <table style="position: center; width: 100%;">
                                            <tr>
                                                <td style="text-align: right; width: 40%;">
                                                    <asp:Label ID="Label1" runat="server" Text="CNP utilizator"></asp:Label>&nbsp;
                                                </td>
                                                <td style="text-align: left; padding: 5px;">
                                                    <asp:TextBox ID="cnpTB" runat="server" Height="27px" Width="250px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="text-align: center; padding: 5px;" colspan="2">
                                                    <asp:Label ID="LabelRezultatAutentificareErr" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center; padding: 5px;" colspan="2">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right; padding: 5px;">
                                                    <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Center" Style="text-align: right;">
                                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/ContPacientNou.aspx" ForeColor="#33ccff">Cont nou</asp:HyperLink>
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center; padding: 5px;" colspan="2">
                                                    <asp:Panel ID="Panel4" runat="server" HorizontalAlign="Center">
                                                        <table style="position: center; width: 100%;">
                                                            <tr>
                                                                <td style="text-align:right;">
                                                                    <asp:Label ID="Label4" runat="server" Text="CNP utilizator"></asp:Label>&nbsp;
                                                                </td>
                                                                <td style="text-align:left; padding:5px;">
                                                                    <asp:TextBox ID="cnpEmailTB" runat="server" Height="27px" Width="250px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align:center; padding:5px;" colspan="2">
                                                                    <asp:Label ID="LabelCnpEmailErr" runat="server" Text=""></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: right; width: 35%;">
                                                                    <asp:Label ID="Label5" runat="server" Text="Adresa e-mail"></asp:Label>&nbsp;
                                                                </td>
                                                                <td style="text-align: left; padding: 5px;">
